...
const LocationField = () => {
  ...
  document.getElementById("mapClose").addEventListener("click",function(){
    ...
    setTimeout(()=>{
    var _latitude = parseFloat(document.getElementById("latitude").value);
    var _longitude = parseFloat(document.getElementById("longitude").value);
  ...
  function initSubmitMap(_latitude, _longitude){
    ...
    // });
       ...
       document.getElementById('hid_count').value =1;
				let clickLocation = new google.maps.LatLng(_latitude, _longitude);
