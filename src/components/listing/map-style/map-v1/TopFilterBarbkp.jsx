    ...
    <>
      ...
      <div className="col-sm-6">
        <div className="page_control_shorting d-flex align-items-center justify-content-center justify-content-sm-end">
          ...
          <div className={`pl15 pr15 bdrl1 bdrr1 d-none d-md-block cursor  ${colstyle? 'menuActive':'#' } `}    onClick={()=>setColstyle(true)}>
            Grid
          </div>
          <div className={`pl15 d-none d-md-block cursor  ${!colstyle? 'menuActive':'#' }`}   onClick={()=>setColstyle(false)}>
            List
          </div>
        </div>
      </div>
