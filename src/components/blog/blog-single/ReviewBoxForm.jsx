        ...
        axios.post('https://www.nearestate.in/reactAPI.php',postObj,{headers:{'Content-Type': 'application/json'}})
          .then(response => {
            ...
            if(response.status=="200"){
              ...
              document.getElementById("customMsg").innerText="Review Added Successfully.";
            }
          })
          .catch(error => {
            console.error(error);
    ...
    <form className="comments_form mt30" onSubmit={handleSubmit}>
      <div className="row">
        ...
        <div className="col-md-12">
          ...
          <button type="submit" id="reviewBtn" className="ud-btn btn-white2">
            Submit Review
