import Mainpage from "./pages/homes/home-v6";
...
import DashboardEditProperty from "./pages/property/(dashboard)/dashboard-edit-property";
...
import Iframedata from "./pages/property/(single-style)/iframedata";
...
import Listview from "./pages/listings/(list-view)/list-v1";
    ...
    <>
      <div className="wrapper ovh">
        <BrowserRouter>
          ...
          <Routes>
            <Route path="/">
            <Route index element={<Mainpage dataFromServer={dataFromServer?.firstData} />} />
              ...
              <Route path="map-view" element={<MapV2 />} />
              ...
              <Route path="privacy" element={<Agents />} />
              <Route path="terms" element={<Agency />} />
              ...
              <Route path="blogpost/:id" element={<BlogSingle />} />

              <Route path="about" element={<About dataFromServer={dataFromServer?.firstData}/>} />
              ...
              <Route path="realview/:id" element={<Faq />} />
              <Route path="realview/:id/:type" element={<Faq />} />
              <Route path="iframedata/:id" element={<Iframedata />} />
              <Route path="compare/:id" element={<Compare />} />
              <Route path="/:id/:id" element={<SingleV6 dataFromServer={dataFromServer?.firstData} />} />
