...
const SingleV6 = ({dataFromServer}) => {
  ...
  useEffect(() => {
    if(listings.length>0){
      if(listings?.durl!="" && listings?.prstatus==1){
        location.href="https://www.nearestate.in/realview/"+listings?.encrypt_id+"/fulldetails";
      }
    ...
    if(listings.length==0){
      ...
      axios.post('https://www.nearestate.in/reactAPI.php',postObj,{headers: { 'Content-Type': 'application/json' }})
        .then(response => {
          if(response.data){
          if(response.data?.durl!="" && response.data?.prstatus==1){
            location.href="https://www.nearestate.in/realview/"+response.data?.encrypt_id+"/fulldetails";
          }  
  ...
  //     "url": [
  //       "https://www.nearestate.in/2bhk-g+1-independent-house-for-sale-in-boduppal-hyderabad/r2mC"
  //     ]
  //   };
  ...
  function contactDetails(id){
    ...
    if(_login.includes("Login")){
      ...
      var re = new RegExp("userid" + "=([^;]+)"); 
      var userId = re.exec(document.cookie);
      var re2 = new RegExp("countryCode" + "=([^;]+)"); 
      var country_code = re2.exec(document.cookie);
      if(userId){
        ...
        .then(response => {
          ...
          if(response.status=="200"){
            if(response.data!=""){
             ...
             document.getElementById("contactBtn").setAttribute("disabled",false);
      ...
      axios.post('https://www.nearestate.in/reactAPI.php',postObj,{headers:{'Content-Type': 'application/json'}})
        .then(response => {
          ...
          if(response.status=="200"){
            ...
            document.getElementById("customMsg").innerText="Property Added to favourites successfully.";
          }
        })
        .catch(error => {
          console.error(error);
  ...
  script.text = JSON.stringify({
    "@context": "https://schema.org",
    "@type": "SiteNavigationElement",
    "url": (listings?.url)?listings?.url:'https://www.nearestate.in/',
    "name":(listings?.title)?listings?.title:'nearestate'
  });
  ...
  return (
    <>
     ...
     <MetaTags
          ...
          image={`https://www.nearestate.in/uploads/gallery/${listings?.property_image}`}
          twitterAccount={''}
      />
      {/* Main Header Nav */}
      <DefaultHeader />
      ...
      <section className="pt60 pb90 bgc-f7">
        <div className="container">
          ...
          <div className="col-lg-8">
            <div className="single-property-content mb30-md">
              <h2 itemScope itemType="http://schema.org/SiteNavigationElement" className="sp-lg-title">
                <a itemProp="url" href={listings.url}>
                  {listings.title}
                </a>
              </h2>
          ...
          <div className="col-lg-4">
            <div className="single-property-content">
              <div className="property-action text-lg-end">
                ...
                <a id="contactbtncol" className="text ml20 fz15 ud-btn btn-white2" onClick={()=>contactbtn()} style={{cursor: 'pointer',background: '#3c6afd',color: '#fff',float: 'right',marginTop: '-13px',marginRight: '17px',padding: '7px 8px 7px 0px',border: 'solid 1px #fff',display:'none'}}><i className="flaticon-user pe-2 align-text-top"></i>View Contact Details</a>
          ...
          <div className="row wrap">
            <div className="col-lg-8">
                                  ...
                                  {listings.image_gallery.length>1 && <div className="row">
                                    <div className="col-lg-7 col-md-8">
                                      <Swiper
                                        ...
                                        loop={true}
                                        spaceBetween={10}
                                        slidesPerView={listings.image_gallery.length}
                                        freeMode={true}
              ...
              {listings?.amenties &&<div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <h4 className="title fz17 mb30">Features &amp; Amenities</h4>
                <div className="row">
                {listings.amenties.split(',')?.map((item, rowIndex) => (
              ...
              {/* End .ps-widget */}
              <span className="hidden" itemProp="address" itemScope="" itemType="http://schema.org/PostalAddress"><span itemProp="areaServed">3 BHK Flat In R.r Residency for Rent  In Manikonda</span><span itemProp="streetAddress">Manikonda</span><span itemProp="addressLocality">hyderabad</span><span itemProp="addressRegion">READY</span><span itemProp="postalCode" className="hidden"></span></span>    
              {listings?.floorplans?.length>0 && <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <h4 className="title fz17 mb30">Floor Plans</h4>
                <div className="row">
                  <div className="col-md-12">
                    <div className="accordion-style1 style2">
                    <div className="accordion" id="accordionExample">
                        {listings?.floorplans?.map((floorPlan, index) => (
                          <div
              ...
              {listings?.durl && userId && <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
    	...
    	; gyroscope; accelerometer" allowFullScreen scrolling="no" src={listings.durl}></iframe>
              ...
              {listings?.review?.length>0 && <div className="ps-widget bgc-white bdrs12 default-box-shadow2 p30 mb30 overflow-hidden position-relative">
                <div className="row">
                  {/* <AllComments /> */}
                  ...
                  <div className="product_single_content mb50">
                    <div className="mbp_pagination_comments">
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="total_review d-flex align-items-center justify-content-between mb20">
                            <h6 className="fz17 mb15" style={{display:'flex'}}>
                              ...
                              {listings?.review.length} Reviews
                            </h6>
                          </div>
                        </div>
                        {/* End review filter */}
                        ...
                        {listings?.review?.map((review, index) => (
              ...
              <div className="column">
                ...
                <div className="agen-personal-info position-relative bgc-white default-box-shadow1 bdrs12 p30 mt30">
                  <div className="widget-wrapper mb-0">
                    ...
                    <input type="hidden" id="fav_id" value="0" /><input type="hidden" id="_isRealview" />
